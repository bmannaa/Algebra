...
module Algebra.EllipticCurve where
...
-- At the moment this is over Q, should be generalized to arbitrary field.
-- Model Q[x,y] with y^2 = 1 - x^4 as a pair such that (a,b) = a + b*sqrt(1-x^4)
-- Call it curve in absence of a better name...
...
propIntersectionPEC i@(Id is) j@(Id js) = 
  length is <= 5 && length js <= 5 ==> isSameIdeal intersectionP i j
